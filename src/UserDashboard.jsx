...
//   const { formId } = useParams();
  ...
  const renderContent = () => {
    switch (activeTab) {
          ...
          <div className="!p-8">
            ...
            <div className="!grid !grid-cols-1 md:!grid-cols-3 !gap-6 !mb-8">
              {[
                ...
                {
                  title: "Health Resources Accessed",
                  value: "15",
                  trend: "+5 this month",
                  color: "yellow",
                },
                ...
                >
                  ...
                  <p className={`!text-${item.color}-500 !text-sm !mt-2`}>
                    {item.trend}
                  </p>
                </div>
              ))}
            ...
            <div className="!bg-white !p-6 !rounded-2xl !shadow-md hover:!shadow-lg !transition-all">
              ...
              <div className="!space-y-4">
                {[
                  {
                    text: 'Screening "Blood Test" updated',
                    time: "2 hours ago",
                  },
                  {
                  ...
                  {
                    text: 'Health Resource "Nutrition Guide" accessed',
                    time: "Yesterday",
                  },
                ].map((activity, idx) => (
          ...
          <div className="!p-8">
            ...
            <div className="!bg-white !p-6 !rounded-2xl !shadow-md">
              <p className="!text-gray-600">
                Update your personal and health profile here.
              </p>
            </div>
          </div>
        );
        ...
        return (
          <div className="!p-8">
            ...
            <div className="!grid !grid-cols-1 md:!grid-cols-2 lg:!grid-cols-3 !gap-6">
              {[
                {
                  title: "My Screening Submissions",
                  description: "View your past health screening submissions.",
                  path: `/user/screenings`,
                },

                {
                  title: "Book a Health Screening",
                  description: "Schedule a new health screening appointment.",
                  path: "/student/book-screening",
                },
                {
                  title: "Health Resources",
                  description:
                    "Access guides and information on maintaining good health.",
                  path: "/student/health-resources",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
      ...
      default:
        return (
          <div className="!p-8 !text-gray-700">Welcome to your dashboard!</div>
        );
    }
  };
